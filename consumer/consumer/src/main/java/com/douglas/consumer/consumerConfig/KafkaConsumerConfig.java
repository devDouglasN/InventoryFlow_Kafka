package com.douglas.consumer.consumerConfig;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, StockDTO> stockConsumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new JsonDeserializer<>(StockDTO.class, false));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, StockDTO> stockKafkaListenerContainerFactory() {
